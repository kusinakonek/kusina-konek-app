...
const LAN_IP = "10.142.135.110"; // <-- Update this to  machine's LAN IP

const DEV_API_URL = Platform.select({
  android: `http://${LAN_IP}:3000/api`, // Works for both Expo Go & Emulator on physical device
  ios: `http://${LAN_IP}:3000/api`,
