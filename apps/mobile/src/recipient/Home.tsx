    ...
    return (
        <SafeAreaView style={styles.safeArea} edges={['top']}>
            <View style={styles.header}>
                <TouchableOpacity style={styles.headerLeft} onPress={() => router.push('/browse-food')}>
                    <Image
            ...
            >
                ...
                {/* Browse Food Button */}
                <TouchableOpacity style={styles.mainButton} onPress={() => router.push('/browse-food')}>
...
const styles = StyleSheet.create({
    ...
    greetingRow: { flexDirection: 'row', alignItems: 'center', gap: wp(12), marginBottom: hp(20) },
    greetingAvatar: {
        width: wp(44), height: wp(44), borderRadius: wp(22), backgroundColor: '#E8F5E9',
        justifyContent: 'center', alignItems: 'center',
    },
    greetingAvatarText: { fontSize: fp(18), fontWeight: 'bold', color: '#2E7D32' },
    ...
    heroContainer: {
        height: hp(160), borderRadius: wp(16), marginBottom: hp(20),
    ...
    recipientStatsCard: {
        backgroundColor: '#E3F2FD', borderRadius: wp(16), padding: wp(20),
        flexDirection: 'row', alignItems: 'center', gap: wp(20),
        borderWidth: 1, borderColor: '#BBDEFB', marginBottom: hp(20),
    },
    recipientStatsIconContainer: { width: wp(64), height: wp(64), justifyContent: 'center', alignItems: 'center' },
    recipientStatsValue: { fontSize: fp(32), fontWeight: 'bold', color: '#1a1a1a', marginBottom: hp(4) },
    recipientStatsLabel: { fontSize: fp(16), fontWeight: '600', color: '#333', marginBottom: hp(8) },
    recipientStatsMeta: { flexDirection: 'row', alignItems: 'center', gap: wp(6), flexWrap: 'wrap' },
